 ...
 *          表示する。バー右側にはエイムピン（中クリックで設置した狙い所）へ
 *          届くのに必要なパワーをマーカーで示し、パワーゲージをそのマーカーの
 *          高さで止めれば狙い通りに届く、という目安として使う。
 *          マーカーの高さは単純な水平距離比ではなく、高低差と風を織り込んで
 *          求めた必要パワー比(AimPinState::requiredPowerRatio)に置く。
